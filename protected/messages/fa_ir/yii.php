...
return array (
  ...
  '{attribute} cannot be blank.' => '{attribute} فاقد مقدار است',
  ...
  '{attribute} must be an integer.' => '  عدد صحیح باشدباید {attribute}',
  ...
  'The system is unable to find the requested action "{action}".' => 'صفحه مورد نظر وجود ندارد ."{action}"',
  ...
  'The verification code is incorrect.' => 'کد تائید نامعتبر است .',
  'The view path "{path}" is not a valid directory.' => 'مسیر ویو "{path}" معتبر نمی باشد.',
  ...
  'You are not authorized to perform this action.' => 'شما دسترسی لازم را ندارید .',
