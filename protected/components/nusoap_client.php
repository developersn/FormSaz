...
class wsdl extends nusoap_base {
    ...
    */
    function webDescription(){
		...
		<style type="text/css">
			* {font-family:tahoma , sans-serif !important; border-radius:8px; margin:4px;padding:4px}
			...
			background-color: #FFC1FF; width: 20%; margin-left: 20px; margin-top: 20px; }
		    .title {
			
			font-family: arial; font-size: 26px; color: #6B6B6B;
			background-color: white; width: 100%;
			margin-left: 0px; margin-right: 0px;
			padding-top: 0px; padding-bottom: 10px;margin-top:0;
			
			}
		    .hidden {
			position: absolute; visibility: hidden; z-index: 200; left: 250px; top: 130px;
			font-family: arial; overflow: hidden; width: 600;
			padding: 20px; font-size: 10px; background-color: #FFA8FF;border:1px solid #FF59FF;
		...
		<div class=content>
			...
			<div class=nav>
				<p>View the <a href="'.str_replace('/index.php','',$PHP_SELF).'?wsdl">WSDL</a> for the service.
